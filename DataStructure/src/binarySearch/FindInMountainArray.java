...
public class FindInMountainArray {
	 ...
	 * 
	 * Step 1: Find a peak element index;
	 * 
	 * Step 2: Now Apply BinarSearch in ascending array => (0 to peak).
	 * 
	 * Step 3: Again apply BN in descending array => (peak+1, arr.length-1);
	 * 
	 * Note :: step 2 and 3 are example of orderAgnostic Array.
	 */
