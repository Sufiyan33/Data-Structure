...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		 * SLL first = new SLL(); SLL second = new SLL();
		 * 
		 * first.insertLast(1); first.insertLast(2); first.insertLast(3);
		 * 
		 * second.insertLast(4); second.insertLast(5); second.insertLast(9);
